...
(()=>{
    var e = {
        ...
        3726: (e,t,r)=>{
            ...
            class Messaging {
                ...
                get _gamePlayerFrame() {
                    ...
                    return e || console.warn("No game player frame to post"),
                    e
                }
                get _gameFrame() {
                    ...
                    return e || console.warn("No game frame to post"),
                    e
                }
            ...
            if ("object" == typeof window)
                window.YandexGamesSDKReactBridge ? (window.YandexGamesSDKReactBridge.messaging || (window.YandexGamesSDKReactBridge.messaging = new Messaging),
                u = window.YandexGamesSDKReactBridge.messaging) : u = new Messaging;
            else {
                const throwNotImpl = ()=>{
        ...
        6085: (e,t,r)=>{
            ...
            const logError = function(e, t) {
                ...
                if (!isRumErrorAvailable())
                    return;
                let {additional: i, level: s, message: c, prefix: u, source: l="catalog", sourceMethod: p} = e
                ...
                s = s || (null === (n = null === (r = window.Ya) || void 0 === r ? void 0 : r.Rum) || void 0 === n ? void 0 : n.ERROR_LEVEL.ERROR) || "error",
                t = t || e,
            ...
            function tryToAppendRevertUniqueIdParam(e) {
                return "1" === (0,
                o.Z)(window.location).revert_unique_id ? (0,
                n.Z)({
                    url: e,
                    params: {
                        revert_unique_id: "1"
            ...
            function isDraft() {
                var e;
                if (null === (e = window.YandexGamesSDK) || void 0 === e ? void 0 : e.game)
              ...
              , s = {
                ...
                sendOnceDeprecatedUsage(e) {
                    ...
                    this.params({
                        ...
                        service: null === (t = window.YandexGamesSDK) || void 0 === t ? void 0 : t.environment.serviceName
                    }))
                },
                params(e) {
                    o.Z.postToParent({
        ...
        5905: (e,t,r)=>{
            ...
            Object.freeze(Object.values(c).reduce(((e,t)=>Object.assign(Object.assign({}, e), {
                [t]: t
            })), {}));
            const p = "/app";
            var d;
            ...
            generateServiceUrls(m.YANDEX, n).concat(generateServiceUrls(m.PLAYHOP, o)).concat(["https://zenadservices.net"]);
            var E;
            !function(e) {
            ...
            const w = n.map((e=>e.replace(".", "\\."))).join("|")
              ...
              , S = (new RegExp("^https://(www\\.)?".concat(m.YANDEX, "\\.(").concat(w, ")$")),
            new RegExp("^https://([^.]+\\.)*".concat(m.YANDEX, "\\.(").concat(w, ")\\/")),
            new RegExp("^https://([^.]+\\.)*".concat(m.PLAYHOP, "\\.(").concat(b, ")$")))
              , O = "(igrotok|igrotok-test|igrotok\\.msup|igrotok\\.games-test|igrotok\\.games-prestable)\\.".concat(m.YANDEX, "\\.(").concat(A, ")");
            new RegExp(O),
            new RegExp("^https://".concat(O, "$")),
            new RegExp("^https://([^.]+\\.)*".concat(m.YANDEX, "\\.(").concat(w, ")").concat(y.YANDEX).concat("/igrotok")),
            new RegExp("^https?://(?:.*?\\.)*".concat(m.YANDEX, "\\.(").concat(w, ")").concat(y.YANDEX, "/manifest/play/\\d+/?"));
            var P;
            !function(e) {
                e.YANDEX = "yandex",
                e.APPODEAL = "appodeal",
        ...
        260: (e,t,r)=>{
            "use strict";
            var n, o = r(4019), a = r(9781), i = r(7854), s = r(111), c = r(6656), u = r(648), l = r(8880), p = r(1320), d = r(3070).f, f = r(9518), h = r(7674), g = r(5112), _ = r(9711), v = i.Int8Array, m = v && v.prototype, y = i.Uint8ClampedArray, E = y && y.prototype, w = v && f(v), b = m && f(m), A = Object.prototype, S = A.isPrototypeOf, O = g("toStringTag"), P = _("TYPED_ARRAY_TAG"), T = o && !!h && "Opera" !== u(i.opera), x = !1, R = {
                Int8Array: 1,
                Uint8Array: 1,
                Uint8ClampedArray: 1,
                Int16Array: 2,
            ...
            for (n in R)
                i[n] || (T = !1);
            if ((!T || "function" != typeof w || w === Function.prototype) && (w = function TypedArray() {
            ...
            T))
                for (n in R)
                    i[n] && h(i[n], w);
            if ((!T || !b || b === A) && (b = w.prototype,
            T))
                for (n in R)
                    i[n] && h(i[n].prototype, b);
            if (T && f(E) !== b && h(E, b),
            a && !c(b, O))
                for (n in x = !0,
                d(b, O, {
        ...
        3331: (e,t,r)=>{
            ...
            if (a) {
                if (!c((function() {
                    ...
                    for (var D, N = (T = function ArrayBuffer(e) {
                        return u(this, T),
                        new P(d(e))
                    }
                    ).prototype = P.prototype, M = _(P), U = 0; M.length > U; )
        ...
        8457: (e,t,r)=>{
            ...
            e.exports = function from(e) {
                var t, r, l, p, d, f, h = o(e), g = "function" == typeof this ? this : Array, _ = arguments.length, v = _ > 1 ? arguments[1] : void 0, m = void 0 !== v, y = u(h), E = 0;
                ...
                null == y || g == Array && i(y))
                    ...
                    r = new g; !(l = d.call(p)).done; E++)
                        f = m ? a(p, v, [l.value, E], !0) : l.value,
                        c(r, E, f);
                return r.length = E,
                r
            }
        ...
        654: (e,t,r)=>{
            ...
            e.exports = function(e, t, r, l, f, E, w) {
                ...
                }, O = t + " Iterator", P = !1, T = e.prototype, x = T[_] || T["@@iterator"] || f && T[f], R = !g && x || getIterationMethod(f), I = "Array" == t && T.entries || x;
                if (I && (b = a(I.call(new e)),
                h !== Object.prototype && b.next && (p || a(b) === h || (i ? i(b, h) : "function" != typeof b[_] && c(b, _, returnThis)),
                s(b, O, !0, !0),
                p && (d[O] = returnThis))),
                f == m && x && x.name !== m && (P = !0,
                R = function values() {
        ...
        408: (e,t,r)=>{
            ...
            e.exports = function(e, t, r) {
                var u, l, p, d, f, h, g, _ = r && r.that, v = !(!r || !r.AS_ENTRIES), m = !(!r || !r.IS_ITERATOR), y = !(!r || !r.INTERRUPTED), E = i(t, _, 1 + v + y), stop = function(e) {
                    return u && c(u),
                    new Result(!0,e)
                }, callFn = function(e) {
                    return v ? (n(e),
                    y ? E(e[0], e[1], stop) : E(e[0], e[1])) : y ? E(e, stop) : E(e)
                };
                if (m)
                    u = e;
                else {
        ...
        ,
        5948: (e,t,r)=>{
            var n, o, a, i, s, c, u, l, p = r(7854), d = r(1236).f, f = r(261).set, h = r(6833), g = r(1036), _ = r(5268), v = p.MutationObserver || p.WebKitMutationObserver, m = p.document, y = p.process, E = p.Promise, w = d(p, "queueMicrotask"), b = w && w.value;
            b || (n = function() {
                var e, t;
            ...
            ,
            h || _ || g || !v || !m ? E && E.resolve ? (u = E.resolve(void 0),
            l = u.then,
            i = function() {
                l.call(u, n)
            }
        ...
        ,
        261: (e,t,r)=>{
            var n, o, a, i = r(7854), s = r(7293), c = r(9974), u = r(490), l = r(317), p = r(6833), d = r(5268), f = i.location, h = i.setImmediate, g = i.clearImmediate, _ = i.process, v = i.MessageChannel, m = i.Dispatch, y = 0, E = {}, w = "onreadystatechange", run = function(e) {
        ...
        9843: (e,t,r)=>{
            ...
            var n = r(2109)
              ...
              , V = function defineProperty(e, t, r) {
                return !(isTypedArrayIndex(e, t = g(t, !0)) && m(r) && _(r, "value")) || _(r, "get") || _(r, "set") || r.configurable || _(r, "writable") && !r.writable || _(r, "enumerable") && !r.enumerable ? k(e, t, r) : (e[t] = r.value,
                e)
            };
            a ? (U || (P.f = q,
            O.f = V,
            ...
            e.exports = function(e, t, r) {
                ...
                U ? i && (_ = t((function(e, t, r, n) {
                    return u(e, _, s),
                    x(m(t) ? isArrayBuffer(t) ? void 0 !== n ? new g(t,h(r, a),n) : void 0 !== r ? new g(t,h(r, a)) : new g(t) : H(t) ? fromList(_, t) : b.call(_, t) : new g(f(t)), e, _)
                }
                )),
                E && E(_, G),
                A(w(g), (function(e) {
        ...
        8674: (e,t,r)=>{
            "use strict";
            var n, o, a, i, s = r(2109), c = r(1913), u = r(7854), l = r(5005), p = r(3366), d = r(1320), f = r(2248), h = r(8003), g = r(6340), _ = r(111), v = r(3099), m = r(5787), y = r(2788), E = r(408), w = r(7072), b = r(6707), A = r(261).set, S = r(5948), O = r(9478), P = r(842), T = r(8523), x = r(2534), R = r(9909), I = r(4705), k = r(5112), C = r(5268), L = r(7392), D = k("species"), N = "Promise", M = R.get, U = R.set, j = R.getterFor(N), G = p, B = u.TypeError, Y = u.document, H = u.process, K = l("fetch"), W = T.f, q = W, V = !!(Y && Y.createEvent && u.dispatchEvent), Z = "function" == typeof PromiseRejectionEvent, z = "unhandledrejection", X = I(N, (function() {
                if (!(y(G) !== String(G))) {
                    if (66 === L)
                        return !0;
                    if (!C && !Z)
                ...
                var n, o;
                V ? ((n = Y.createEvent("Event")).promise = t,
                n.reason = r,
                n.initEvent(e, !1, !0),
                u.dispatchEvent(n)) : n = {
                    promise: t,
        ...
        4603: (e,t,r)=>{
            ...
            if (n && a("RegExp", !w || b || f((function() {
                ...
                for (var A = function RegExp(e, t) {
                    ...
                    e = e.source),
                    b && (r = !!t && t.indexOf("y") > -1) && (t = t.replace(/y/g, ""));
        ...
        6373: (e,t,r)=>{
            ...
            var n = r(2109)
              ...
              , x = o((function RegExpStringIterator(e, t, r, n) {
                b(this, {
                    type: w,
                    regexp: e,
                    string: t,
            ...
            n("replace", 2, (function(e, t, r, n) {
                ...
                , function(e, n) {
                    ...
                    for (var A, S = "", O = 0, P = 0; P < w.length; P++) {
                        b = w[P];
                        for (var T = String(b[0]), x = p(d(i(b.index), v.length), 0), R = [], I = 1; I < b.length; I++)
        ...
        1637: (e,t,r)=>{
            ...
            s(M, {
                ...
                set: function set(e, t) {
                    validateArgumentsLength(arguments.length, 1);
                    for (var r, n = x(this), o = n.entries, a = !1, i = e + "", s = t + "", c = 0; c < o.length; c++)
                ...
                sort: function sort() {
                    var e, t, r, n = x(this), o = n.entries, a = o.slice();
                    for (o.length = 0,
                    r = 0; r < a.length; r++) {
                        for (e = a[r],
                        t = 0; t < r; t++)
            ...
            i(M, S, M.entries),
            i(M, "toString", (function toString() {
            ...
            a || "function" != typeof b || "function" != typeof A || n({
                ...
                fetch: function fetch(e) {
                    ...
                    h(r) === O && ((n = t.headers ? new A(t.headers) : new A).has("content-type") || n.set("content-type", "application/x-www-form-urlencoded;charset=UTF-8"),
                    t = v(t, {
                        body: m(0, String(r)),
                        headers: m(0, n)
                    }))),
        ...
        285: (e,t,r)=>{
            "use strict";
            r(8783);
            var n, o = r(2109), a = r(9781), i = r(590), s = r(7854), c = r(6048), u = r(1320), l = r(5787), p = r(6656), d = r(1574), f = r(8457), h = r(8710).codeAt, g = r(3197), _ = r(8003), v = r(1637), m = r(9909), y = s.URL, E = v.URLSearchParams, w = v.getState, b = m.set, A = m.getterFor("URL"), S = Math.floor, O = Math.pow, P = "Invalid scheme", T = "Invalid host", x = "Invalid port", R = /[A-Za-z]/, I = /[\d+-.A-Za-z]/, k = /\d/, C = /^(0x|0X)/, L = /^[0-7]+$/, D = /^\d+$/, N = /^[\dA-Fa-f]+$/, M = /[\u0000\t\u000A\u000D #%/:?@[\\]]/, U = /[\u0000\t\u000A\u000D #/:?@[\\]]/, j = /^[\u0000-\u001F ]+|[\u0000-\u001F ]+$/g, G = /[\t\u000A\u000D]/g, parseHost = function(e, t) {
                var r, n, o;
                if ("[" == t.charAt(0)) {
                ...
                n = 0; n < t; n++) {
                    if ("" == (o = c[n]))
                        return e;
                    if (a = 10,
                    o.length > 1 && "0" == o.charAt(0) && (a = C.test(o) ? 16 : 8,
                    o = o.slice(8 == a ? 1 : 2)),
                    "" === o)
                        i = 0;
                    else {
                        if (!(10 == a ? D : 8 == a ? L : N).test(o))
                            return e;
                        i = parseInt(o, a)
                    }
                    r.push(i)
            ...
            }, q = {}, V = {}, Z = {}, z = {}, X = {}, $ = {}, J = {}, Q = {}, ee = {}, te = {}, re = {}, ne = {}, oe = {}, ae = {}, ie = {}, se = {}, ce = {}, ue = {}, le = {}, pe = {}, de = {}, parseURL = function(e, t, r, o) {
                var a, i, s, c, u, l = r || q, d = 0, h = "", g = !1, _ = !1, v = !1;
                for (r || (e.scheme = "",
                e.username = "",
                e.password = "",
                e.host = null,
                ...
                a = f(t); d <= a.length; ) {
                    ...
                    case V:
                        if (i && (I.test(i) || "+" == i || "-" == i || "." == i))
                            ...
                            if (r && (isSpecial(e) != p(W, h) || "file" == h && (includesCredentials(e) || null !== e.port) || "file" == e.scheme && !e.host))
                                return;
                            if (e.scheme = h,
                            r)
                                return void (isSpecial(e) && W[e.scheme] == e.port && (e.port = null));
                            h = "",
                            "file" == e.scheme ? l = ae : isSpecial(e) && o && o.scheme == e.scheme ? l = z : isSpecial(e) ? l = Q : "/" == a[d + 1] ? (l = X,
                ...
                var t, r, n = l(this, fe, "URL"), o = arguments.length > 1 ? arguments[1] : void 0, i = String(e), s = b(n, {
                    type: "URL"
                });
                if (void 0 !== o)
                    if (o instanceof fe)
                ...
                if (S)
                    ...
                    if (P) {
                        var T = u(A)
                          ...
                          , R = !T && !x && g(A);
                        O = A,
                        T || x || R ? u(b) ? O = b : l(b) ? O = i(b) : x ? (P = !1,
                        O = o(A, !0)) : R ? (P = !1,
                        O = a(A, !0)) : O = [] : h(A) || c(A) ? (O = b,
                        c(b) ? O = v(b) : f(b) && !d(b) || (O = s(A))) : P = !1
                    }
                    P && (w.set(A, O),
                    y(O, A, m, E, w),
                    w.delete(A)),
    ...
    (()=>{
        ...
        const l = "object" == typeof window && -1 !== String(window.location).indexOf("".concat("sdk-debug-mode", "=1"));
        ...
        const E = getDebugLog("src/sdk/utils/env")
          , w = "undefined" != typeof window && ((null === (m = window.appData) || void 0 === m ? void 0 : m.env) || (null === (y = window.gameTokAppData) || void 0 === y ? void 0 : y.env)) || void 0
        ...
        const S = (0,
        n.Z)(i.location)
          , O = (A || parseInt(S.test_uid, 10),
        A || S.test_email,
        A || S.test_oauth,
        "true" === S.yandexapp)
          , P = ((S.origin || void 0 || i.location.origin).match(/[\.\/]yandex\.([a-z\.]+)$/) || ["", "ru"])[1]
          , T = (w ? w.SDK_BACKEND_URL : "https://games-sdk.yandex.%TLD%/games/api/sdk/v1") || ""
          , x = (w ? w.PLAYHOP_SDK_BACKEND_URL : "https://games-sdk.playhop.%TLD%/games/api/sdk/v1") || ""
          , R = function checkPlayhopOrigin() {
            return Boolean(i.location.origin.match(o.SB))
        }() ? x.replace("%TLD%", P) : T.replace("%TLD%", P);
        E("BACKEND_SDK_URL", R);
        w && w.OAUTH_CLIENT_ID;
        ...
        const Y = "undefined" != typeof window && "1" === (0,
        n.Z)(window.location)[o._k]
          , H = ("undefined" != typeof window && (0,
        n.Z)(window.location)[o.p4],
        getDebugLog("NoAds"))
          , K = "yandex-games-no-ads-style";
        function resetAdvCallbacks() {
            Array.isArray(window.adfoxAsyncParams) && 0 !== window.adfoxAsyncParams.length && (window.adfoxAsyncParams = []),
        ...
        class AdvManager {
            constructor(r) {
                ...
                (null === (n = window.YandexGamesSDKEnvironment) || void 0 === n ? void 0 : n.isWorldWide) ? this.setDisabledState(!0) : Y && disableBannerAds(),
                ...
                t.Z.onExternalMessage("adv-manager", (t=>{
                    ...
                    case "adv-callback-offline":
                        this.adOpened = !1,
                        this._hideAdv(),
                        null === (u = (c = this.callbacks).onOffline) || void 0 === u || u.call(c);
                        break;
                    ...
                    case "rewarded-video-callback-close":
                        this.adOpened = !1,
                        null === (g = (h = this.callbacks).onClose) || void 0 === g || g.call(h);
                        break;
                    case "rewarded-video-callback-error":
                        this.adOpened = !1,
                        null === (v = (_ = this.callbacks).onError) || void 0 === v || v.call(_, new Error(t.data.data.error.message,{
                            cause: t.data.data.error
                        }));
                        break;
            ...
            setDisabledState(e) {
                ...
                e ? disableAds() : function enableContentAds() {
                    W && (W = !1)
                }()
            }
            openAdLock(t, r) {
                var n, o;
                let a;
                return this.adOpened ? (a = new Error("Another ad already opened"),
                null === (n = t.onError) || void 0 === n || n.call(t, a)) : r && Math.abs(Date.now() - this.lastCloseFullscreenTime) < 5e3 && (a = new Error("Please, don't try to open advertising often than once per ".concat(5e3, "ms")),
                (0,
                k.mv)() && (null === (o = t.onError) || void 0 === o || o.call(t, a))),
                a ? ((0,
                e.fF)(a),
                this._callOnAdvClose(),
                !1) : (this.adOpened = !0,
                !0)
            }
            showFullscreenAdv({callbacks: r={}}={}) {
                if (this._addCallbacks(r, ["onClose", "onOpen", "onError", "onOffline"]),
                this.openAdLock(r, !0))
            ...
            showBannerAdv() {
                return new Promise((r=>{
                    var n;
                    (null === (n = window.YandexGamesSDKEnvironment) || void 0 === n ? void 0 : n.isStickyBannerEnabled) ? this.stickyAdOpened ? r({
                        stickyAdvIsShowing: !0
                    }) : t.Z.postToParent({
                        type: "adv-manager",
                        action: "adv-show-sticky-banner"
                    }).then((({data: e})=>{
                        this.stickyAdOpened = !0,
                        r(e)
                    }
                    )).catch((t=>{
                        this.stickyAdOpened = !1,
        ...
        const Z = new class AuthManagerPrivate {
            ...
            switchAuthState(e) {
                this.hasAuthValue !== e && (V("switch auth state to ".concat(e)),
                this.hasAuthValue = e)
            }
            getAuthState() {
                t.Z.postToParent({
        ...
        const ae = "".concat(R, "/leaderboard")
          ...
          , ie = throttle(((e,t,r={})=>commonPostData({
            api: ae,
            timeout: 3e3,
            path: e,
            data: t,
        ...
        class Leaderboards {
            ...
            transformLeaderboardEntry(e) {
                ...
                return Object.assign(Object.assign({}, e), {
                    player: {
                        getAvatarSrc: (e="medium")=>(ee[e] || (e = "medium"),
                        "".concat(i, "/").concat(ee[e])),
                        getAvatarSrcSet: (e="medium")=>(ee[e] || (e = "medium"),
                        "".concat(i, "/").concat(ee[e], " 1x, ").concat(i, "/").concat(te[e], " 2x")),
                        lang: r,
                        publicName: n,
                        scopePermissions: o,
                        uniqueID: a
        ...
        ;
        var se, ce = __webpack_require__(1420);
        ...
        class Product {
            ...
            getPriceCurrencyImage(e=be.SMALL) {
                if (e === be.SVG)
                    return "".concat(Ae, "/currency-icon-m.svg");
                let t = "s";
                switch (e) {
                case be.MEDIUM:
                case be.SMALL:
        ...
        class LastSendGuard {
            ...
            validate(e) {
                ...
                return function byteLength(e) {
                    ...
                    error: new Error("The data is too large (bigger then ".concat(Re, " bytes).")),
                    reject: !0
                } : this._dataHash === t ? {
        ...
        class Player extends class PlayerBase {
            ...
            getPhoto(e="medium") {
                ...
                return this._personalInfo.avatarIdHash ? "".concat(re, "/avatar/").concat(this._personalInfo.avatarIdHash, "/").concat(t) : "".concat(ne).concat(Q, "/").concat(t)
            }
        }
        {
            constructor(e, t) {
                ...
                this[Ie] = void 0,
                this[ke] = t,
                Le && Le.isSamePlayer(this.getUniqueID()) || (Le = new LastSendGuard(this.getUniqueID()))
            }
            getIDsPerGame() {
                return this._fetchData("-ids-per-game")
            }
            getData(e) {
                return void 0 === this[Ie] ? this._fetchData("/data").then((t=>(this[Ie] = t,
                filterDataByKeys(t, e)))) : Promise.resolve(filterDataByKeys(this[Ie], e))
            }
            setData(t, r=!1) {
            ...
            _fetchData(e) {
                return fetch_fetchData((0,
                k.H8)("".concat(e).concat(this[ke].signed ? "-signed" : ""))).then(convertResponseData)
            }
            _postData(e, t) {
        ...
        const Ne = De || function getInMemoryLocalStorage() {
            let e = {};
            return {
                clear() {
                    e = {}
        ...
        class LocalStorageWrapper {
            static setup() {
                Fe && Object.defineProperty(window, "localStorage", {
                    get: function() {
                        return Be(),
                        Ne
                    }
                }),
                je && Ge && LocalStorageWrapper.setProxy() && LocalStorageWrapper.backup()
            }
            static load() {
                ...
                LocalStorageWrapper.onloadPromise_) : Promise.resolve(Ne)
            }
        ...
        const Ye = new class ClipboardPublic {
          ...
          , He = {
            ...
            meego: ()=>find("meego"),
            mobile: function() {
                return He.androidPhone() || He.iphone() || He.ipod() || He.windowsPhone() || He.blackberryPhone() || He.fxosPhone() || He.meego()
            },
            ...
            tablet: function() {
                return He.ipad() || He.androidTablet() || He.blackberryTablet() || He.windowsTablet() || He.fxosTablet()
            },
            tv: ()=>We.some((e=>find(e))),
            get type() {
            ...
            windowsTablet: ()=>He.windows() && find("touch") && !He.windowsPhone()
        }
          , Ke = "undefined" == typeof window ? "" : window.navigator.userAgent.toLowerCase()
          , We = ["googletv", "viera", "smarttv", "internet.tv", "netcast", "nettv", "appletv", "boxee", "kylo", "roku", "dlnadoc", "pov_tv", "hbbtv", "ce-html", "yandexmodule", "androidtv"];
        ...
        const Je = new class ErrorListener {
            ...
            _unsafeHandleErrorEvent(e, t) {
                ...
                (Xe || (null == s ? void 0 : s.additional)) && (c.additional = Object.assign(Object.assign({}, null == s ? void 0 : s.additional), Xe)),
                this._postError(c, t)
            }
            _postError(t, r) {
                var n;
            ...
            function ensureOptionsValues(e={}) {
                ...
                function ensureScreen(e) {
                    ...
                    return t = function ensureFullscreen(e) {
                        ...
                        }(e.fullscreen) : e.fullscreen = !Ve.isDesktop();
                        return e
                    }(t),
        ...
        class ScopesChecker {
            ...
            isNeedToAskUser() {
                return [ot.AVATAR, ot.NAME].some((e=>this._requestedScopes.includes(e) && this._scopePermissions[e] === it.NOT_SET))
            }
            _validateRequestedScopes(e) {
                let t = [];
                t = Array.isArray(e) ? Array.from(e) : void 0 === e || !0 === e ? [at] : [];
                const r = t.indexOf(at);
                return -1 !== r && t.splice(r, 1, ot.AVATAR, ot.NAME),
                t
            }
        }
        ...
        const ut = ["passport.yandex", "an.yandex.ru", "avatars.mds.yandex.net", "/api/"];
        ...
        function setTmpPlayTimeTimer(e) {
            window.setTimeout((()=>{
                ...
                (new Image).src = "images/blank.png?https://mc.yandex.ru/watch/49035923?&page-url=".concat(encodeURIComponent(window.location.href), "&page-ref=").concat(encodeURIComponent(document.referrer), "&charset=utf-8&site-info=").concat(encodeURIComponent(JSON.stringify(t)))
            }
            ), 1e3 * e)
        }
        ...
        Y && (((e=null)=>{
            null === e && (e = window),
            ["testing", "prestable", "production"].includes("production") && !l && function navigator_isIOS() {
        ...
        (()=>{
            if (window.top !== window)
                return;
            if (-1 === window.location.hostname.indexOf("games.s3.yandex.net") && -1 === window.location.hostname.indexOf("games-storage.yandex.net"))
                return;
            const e = (0,
            k.rh)();
            if (!e)
            ...
            let o;
            o = -1 === n.indexOf("games.s3.yandex.net") ? "https://yandex.com/games/app/".concat(e).concat(t).concat(r) : "https://yandex.ru/games/app/".concat(e).concat(t).concat(r),
        ...
        class YaGames {
            ...
            static init(r) {
                return ft ? (console.warn("YaGames was initialized"),
                ft) : (ft = new Promise(((n,o)=>{
                    const onFeaturesLoad = a=>{
                        try {
                            r = ensureOptions(a, r),
                            waitDocumentReady().then((()=>{
                                const e = new YaGamesCreater(r);
                                Z.hasAuth() ? e.getPlayer({
                                    scopes: !1
                                }).then((()=>n(e))).catch((()=>n(e))) : (t.Z.post({
                                    type: "subscriptions",
                                    action: "set",
                                    data: {
                                        subscriptions: {}
